...
export const credentials = sqliteTable(
  "credentials",
  {
    ...
    id: text("id").notNull().default(uuid()),
  ...
  (table) => [
    ...
    uniqueIndex("credentials_revocation_unique").on(
      table.revocationList,
      table.revocationIndex
    ),
...
export const encryptedCredentials = sqliteTable(
  ...
  (table) => [
    uniqueIndex("encrypted_credentials_credential_unique").on(
      table.credentialId
    ),
  ]
);
