...
const schema31 = {
  ...
  properties: {
    type: {
      ...
      items: { type: 'string' },
      allOf: [
        { contains: { const: 'ModifyEvent', minContains: 1 } },
    ...
    modifiedProduct: {
      ...
      description:
        'An array of products and quantities for this intervention (repair, inspection, etc)',
    },
    modifiedAtFacility: {
      type: 'object',
      properties: {
...
function validate20(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.modifiedProduct === undefined) {
      const err4 = {
        instancePath,
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'modifiedProduct' },
        message: "must have required property '" + 'modifiedProduct' + "'",
      };
      if (vErrors === null) {
        vErrors = [err4];
      } else {
    ...
    if (data.modifiedAtFacility === undefined) {
      const err5 = {
        instancePath,
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'modifiedAtFacility' },
        message: "must have required property '" + 'modifiedAtFacility' + "'",
      };
      if (vErrors === null) {
        vErrors = [err5];
      } else {
    ...
    if (data.type !== undefined) {
      ...
      if (Array.isArray(data0)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          const _errs6 = errors;
          if ('ModifyEvent' !== data0[i0]) {
            const err6 = {
              instancePath: instancePath + '/type/' + i0,
              schemaPath: '#/properties/type/allOf/0/contains/const',
              keyword: 'const',
              params: { allowedValue: 'ModifyEvent' },
              message: 'must be equal to constant',
            };
            if (vErrors === null) {
              vErrors = [err6];
    ...
    if (data.modifiedProduct !== undefined) {
      let data31 = data.modifiedProduct;
      if (Array.isArray(data31)) {
        const len10 = data31.length;
        for (let i10 = 0; i10 < len10; i10++) {
          if (
            !validate29(data31[i10], {
              instancePath: instancePath + '/modifiedProduct/' + i10,
              parentData: data31,
        ...
        const err51 = {
          instancePath: instancePath + '/modifiedProduct',
          schemaPath: '#/properties/modifiedProduct/type',
          keyword: 'type',
          params: { type: 'array' },
          message: 'must be array',
        };
    ...
    if (data.modifiedAtFacility !== undefined) {
      let data33 = data.modifiedAtFacility;
      if (data33 && typeof data33 == 'object' && !Array.isArray(data33)) {
        if (data33.id === undefined) {
          const err52 = {
            instancePath: instancePath + '/modifiedAtFacility',
            schemaPath: '#/properties/modifiedAtFacility/required',
            keyword: 'required',
            params: { missingProperty: 'id' },
            message: "must have required property '" + 'id' + "'",
          };
          ...
          if (Array.isArray(data34)) {
            ...
            for (let i11 = 0; i11 < len11; i11++) {
              ...
              if ('Facility' !== data34[i11]) {
                const err54 = {
                  instancePath: instancePath + '/modifiedAtFacility/type/' + i11,
                  schemaPath:
                    '#/properties/modifiedAtFacility/properties/type/allOf/0/contains/const',
                  keyword: 'const',
            ...
            if (!valid28) {
              const err55 = {
                instancePath: instancePath + '/modifiedAtFacility/type',
                schemaPath: '#/properties/modifiedAtFacility/properties/type/allOf/0/contains',
                keyword: 'contains',
                params: { minContains: 1 },
                message: 'must contain at least 1 valid item(s)',
              };
          ...
          if (Array.isArray(data34)) {
            ...
            for (let i12 = 0; i12 < len12; i12++) {
              if (typeof data34[i12] !== 'string') {
                const err56 = {
                  instancePath: instancePath + '/modifiedAtFacility/type/' + i12,
                  schemaPath: '#/properties/modifiedAtFacility/properties/type/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            const err57 = {
              instancePath: instancePath + '/modifiedAtFacility/type',
              schemaPath: '#/properties/modifiedAtFacility/properties/type/type',
              keyword: 'type',
              params: { type: 'array' },
              message: 'must be array',
            };
        ...
        if (data33.id !== undefined) {
          ...
          if (typeof data37 === 'string') {
            if (!formats0(data37)) {
              const err58 = {
                instancePath: instancePath + '/modifiedAtFacility/id',
                schemaPath: '#/properties/modifiedAtFacility/properties/id/format',
                keyword: 'format',
                params: { format: 'uri' },
                message: 'must match format "' + 'uri' + '"',
              };
            ...
            const err59 = {
              instancePath: instancePath + '/modifiedAtFacility/id',
              schemaPath: '#/properties/modifiedAtFacility/properties/id/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data33.name !== undefined) {
          if (typeof data33.name !== 'string') {
            const err60 = {
              instancePath: instancePath + '/modifiedAtFacility/name',
              schemaPath: '#/properties/modifiedAtFacility/properties/name/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        const err61 = {
          instancePath: instancePath + '/modifiedAtFacility',
          schemaPath: '#/properties/modifiedAtFacility/type',
          keyword: 'type',
          params: { type: 'object' },
          message: 'must be object',
        };
