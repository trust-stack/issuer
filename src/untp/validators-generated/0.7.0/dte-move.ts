...
const schema31 = {
  ...
  properties: {
    type: {
      ...
      items: { type: 'string' },
      allOf: [
        { contains: { const: 'MoveEvent', minContains: 1 } },
...
function validate20(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.movedProduct === undefined) {
      const err4 = {
        instancePath,
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'movedProduct' },
        message: "must have required property '" + 'movedProduct' + "'",
      };
      if (vErrors === null) {
        vErrors = [err4];
      } else {
    ...
    if (data.fromFacility === undefined) {
      const err5 = {
        instancePath,
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'fromFacility' },
        message: "must have required property '" + 'fromFacility' + "'",
      };
      if (vErrors === null) {
        vErrors = [err5];
      } else {
    ...
    if (data.toFacility === undefined) {
      const err6 = {
        instancePath,
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'toFacility' },
        message: "must have required property '" + 'toFacility' + "'",
      };
      if (vErrors === null) {
        vErrors = [err6];
      } else {
    ...
    if (data.type !== undefined) {
      ...
      if (Array.isArray(data0)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          const _errs6 = errors;
          if ('MoveEvent' !== data0[i0]) {
            const err7 = {
              instancePath: instancePath + '/type/' + i0,
              schemaPath: '#/properties/type/allOf/0/contains/const',
              keyword: 'const',
              params: { allowedValue: 'MoveEvent' },
              message: 'must be equal to constant',
            };
            if (vErrors === null) {
              vErrors = [err7];
    ...
    if (data.movedProduct !== undefined) {
      let data31 = data.movedProduct;
      if (Array.isArray(data31)) {
        const len10 = data31.length;
        for (let i10 = 0; i10 < len10; i10++) {
          if (
            !validate29(data31[i10], {
              instancePath: instancePath + '/movedProduct/' + i10,
              parentData: data31,
        ...
        const err52 = {
          instancePath: instancePath + '/movedProduct',
          schemaPath: '#/properties/movedProduct/type',
          keyword: 'type',
          params: { type: 'array' },
          message: 'must be array',
        };
    ...
    if (data.fromFacility !== undefined) {
      let data33 = data.fromFacility;
      if (data33 && typeof data33 == 'object' && !Array.isArray(data33)) {
        if (data33.id === undefined) {
          const err53 = {
            instancePath: instancePath + '/fromFacility',
            schemaPath: '#/properties/fromFacility/required',
            keyword: 'required',
            params: { missingProperty: 'id' },
            message: "must have required property '" + 'id' + "'",
          };
        ...
        if (data33.type !== undefined) {
          ...
          if (Array.isArray(data34)) {
            const _errs78 = errors;
            const len11 = data34.length;
            for (let i11 = 0; i11 < len11; i11++) {
              const _errs79 = errors;
              if ('Facility' !== data34[i11]) {
                const err55 = {
                  instancePath: instancePath + '/fromFacility/type/' + i11,
                  schemaPath: '#/properties/fromFacility/properties/type/allOf/0/contains/const',
                  keyword: 'const',
            ...
            if (!valid28) {
              const err56 = {
                instancePath: instancePath + '/fromFacility/type',
                schemaPath: '#/properties/fromFacility/properties/type/allOf/0/contains',
                keyword: 'contains',
                params: { minContains: 1 },
                message: 'must contain at least 1 valid item(s)',
              };
          ...
          if (Array.isArray(data34)) {
            ...
            for (let i12 = 0; i12 < len12; i12++) {
              if (typeof data34[i12] !== 'string') {
                const err57 = {
                  instancePath: instancePath + '/fromFacility/type/' + i12,
                  schemaPath: '#/properties/fromFacility/properties/type/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            const err58 = {
              instancePath: instancePath + '/fromFacility/type',
              schemaPath: '#/properties/fromFacility/properties/type/type',
              keyword: 'type',
              params: { type: 'array' },
              message: 'must be array',
            };
        ...
        if (data33.id !== undefined) {
          let data37 = data33.id;
          if (typeof data37 === 'string') {
            if (!formats0(data37)) {
              const err59 = {
                instancePath: instancePath + '/fromFacility/id',
                schemaPath: '#/properties/fromFacility/properties/id/format',
                keyword: 'format',
                params: { format: 'uri' },
                message: 'must match format "' + 'uri' + '"',
              };
            ...
            const err60 = {
              instancePath: instancePath + '/fromFacility/id',
              schemaPath: '#/properties/fromFacility/properties/id/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data33.name !== undefined) {
          if (typeof data33.name !== 'string') {
            const err61 = {
              instancePath: instancePath + '/fromFacility/name',
              schemaPath: '#/properties/fromFacility/properties/name/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        const err62 = {
          instancePath: instancePath + '/fromFacility',
          schemaPath: '#/properties/fromFacility/type',
          keyword: 'type',
          params: { type: 'object' },
          message: 'must be object',
        };
    ...
    if (data.toFacility !== undefined) {
      let data39 = data.toFacility;
      if (data39 && typeof data39 == 'object' && !Array.isArray(data39)) {
        if (data39.id === undefined) {
          const err63 = {
            instancePath: instancePath + '/toFacility',
            schemaPath: '#/properties/toFacility/required',
            keyword: 'required',
            params: { missingProperty: 'id' },
            message: "must have required property '" + 'id' + "'",
          };
        ...
        if (data39.type !== undefined) {
          let data40 = data39.type;
          if (Array.isArray(data40)) {
            const _errs91 = errors;
            const len13 = data40.length;
            for (let i13 = 0; i13 < len13; i13++) {
              const _errs92 = errors;
              if ('Facility' !== data40[i13]) {
                const err65 = {
                  instancePath: instancePath + '/toFacility/type/' + i13,
                  schemaPath: '#/properties/toFacility/properties/type/allOf/0/contains/const',
                  keyword: 'const',
                  params: { allowedValue: 'Facility' },
                  message: 'must be equal to constant',
                };
            ...
            if (!valid33) {
              const err66 = {
                instancePath: instancePath + '/toFacility/type',
                schemaPath: '#/properties/toFacility/properties/type/allOf/0/contains',
                keyword: 'contains',
                params: { minContains: 1 },
                message: 'must contain at least 1 valid item(s)',
              };
          ...
          if (Array.isArray(data40)) {
            ...
            for (let i14 = 0; i14 < len14; i14++) {
              if (typeof data40[i14] !== 'string') {
                const err67 = {
                  instancePath: instancePath + '/toFacility/type/' + i14,
                  schemaPath: '#/properties/toFacility/properties/type/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            const err68 = {
              instancePath: instancePath + '/toFacility/type',
              schemaPath: '#/properties/toFacility/properties/type/type',
              keyword: 'type',
              params: { type: 'array' },
              message: 'must be array',
            };
        ...
        if (data39.id !== undefined) {
          let data43 = data39.id;
          if (typeof data43 === 'string') {
            if (!formats0(data43)) {
              const err69 = {
                instancePath: instancePath + '/toFacility/id',
                schemaPath: '#/properties/toFacility/properties/id/format',
                keyword: 'format',
                params: { format: 'uri' },
                message: 'must match format "' + 'uri' + '"',
              };
            ...
            const err70 = {
              instancePath: instancePath + '/toFacility/id',
              schemaPath: '#/properties/toFacility/properties/id/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data39.name !== undefined) {
          if (typeof data39.name !== 'string') {
            const err71 = {
              instancePath: instancePath + '/toFacility/name',
              schemaPath: '#/properties/toFacility/properties/name/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        const err72 = {
          instancePath: instancePath + '/toFacility',
          schemaPath: '#/properties/toFacility/type',
          keyword: 'type',
          params: { type: 'object' },
          message: 'must be object',
        };
    ...
    if (data.consignmentId !== undefined) {
      let data45 = data.consignmentId;
      if (typeof data45 === 'string') {
        if (!formats0(data45)) {
          const err73 = {
            instancePath: instancePath + '/consignmentId',
            schemaPath: '#/properties/consignmentId/format',
            keyword: 'format',
            params: { format: 'uri' },
            message: 'must match format "' + 'uri' + '"',
          };
        ...
        const err74 = {
          instancePath: instancePath + '/consignmentId',
          schemaPath: '#/properties/consignmentId/type',
          keyword: 'type',
          params: { type: 'string' },
          message: 'must be string',
        };
